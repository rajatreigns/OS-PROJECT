# OS-PROJECT
This project is assigned by the college for the evaluation as an internal exams.
This is the project of the operating system subject based on ROUND ROBIN ALGORITHM for SCHEDULER

GIVEN BELOW IS THE PROBLEM WHICH IS NEEDED TO BE SOLVED AND ALSO IT's TEST CASE NEEDS TO BE PASSED
